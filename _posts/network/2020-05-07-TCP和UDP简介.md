...
[SO_REUSEADDR_SO_REUSEPORT]:/SO_REUSEADDR&SO_REUSEPORT
...
2. bind
	...
	bind函数就是把第1步创建的套接字和套接字地址绑定，就像去电信运营商申请电话号码一样，关于更多bind函数的相关知识可以参考这篇[文章][SO_REUSEADDR_SO_REUSEPORT]，bind函数签名如下：
